...
class NLPDidatico:
    ...
    def preprocessamento2(self, palavrasVaziasIn):
        self.palavrasVazias = palavrasVaziasIn

        # limpa
        self.corpusProcessadado = [self.limpaSenteca(texto) for texto in self.corpus]
        return self.corpusProcessadado

    def limpaSenteca(self, in_text):
        ...
        text = text.split()
        # filtra as palavras vazias e aplica 'stemmer'
        text = [self.stemmer.stem(word) for word in text if not word in set(self.palavrasVazias)]
